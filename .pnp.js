...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "@ambic/admin-service",
        "reference": "workspace:src/services/admin-service"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["@ambic/admin-service", ["workspace:src/services/admin-service"]],
    ...
    "packageRegistryData": [
      ...
      ["@ambic/admin-service", [
        ["workspace:src/services/admin-service", {
          "packageLocation": "./src/services/admin-service/",
          "packageDependencies": [
            ["@ambic/admin-service", "workspace:src/services/admin-service"],
